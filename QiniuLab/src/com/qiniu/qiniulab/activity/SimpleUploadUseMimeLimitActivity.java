...
public class SimpleUploadUseMimeLimitActivity extends ActionBarActivity {

	private SimpleUploadUseMimeLimitActivity context;
	...
	private TextView uploadMimeLimitTextView;
	...
	public SimpleUploadUseMimeLimitActivity() {
		this.context = this;
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.simple_upload_use_mimelimit_activity);
		this.uploadTokenTextView = (TextView) this
				.findViewById(R.id.simple_upload_use_mimelimit_upload_token);
		this.uploadFileTextView = (TextView) this
				.findViewById(R.id.simple_upload_use_mimelimit_upload_file);
		this.uploadFileKeyEditText = (EditText) this
				.findViewById(R.id.simple_upload_use_mimelimit_file_key);
		this.uploadMimeLimitTextView = (TextView) this
				.findViewById(R.id.simple_upload_use_mimelimit_textview);
		this.uploadProgressBar = (ProgressBar) this
				.findViewById(R.id.simple_upload_use_mimelimit_upload_progressbar);
		this.uploadProgressBar.setMax(100);
		this.uploadStatusLayout = (LinearLayout) this
				.findViewById(R.id.simple_upload_use_mimelimit_status_layout);
		this.uploadSpeedTextView = (TextView) this
				.findViewById(R.id.simple_upload_use_mimelimit_upload_speed_textview);
		this.uploadFileLengthTextView = (TextView) this
				.findViewById(R.id.simple_upload_use_mimelimit_upload_file_length_textview);
		this.uploadPercentageTextView = (TextView) this
				.findViewById(R.id.simple_upload_use_mimelimit_upload_percentage_textview);
		this.uploadStatusLayout.setVisibility(LinearLayout.INVISIBLE);
		this.uploadLogTextView = (TextView) this
				.findViewById(R.id.simple_upload_use_mimelimit_log_textview);
						...
						if (respInfo.statusCode == 200) {
							try {
								String uploadToken = jsonData
										.getString("uptoken");
								String mimeLimit = jsonData
										.getString("mimeLimit");
								uploadTokenTextView.setText(uploadToken);
								uploadMimeLimitTextView.setText(mimeLimit);
