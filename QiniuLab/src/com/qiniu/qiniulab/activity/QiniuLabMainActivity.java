...
public class QiniuLabMainActivity extends ActionBarActivity {
	...
	private void inflateExpandableListView() {
		...
		this.exampleGroupTitleList.add(this
				.getString(R.string.qiniu_public_download));
		this.exampleGroupTitleList.add(this
				.getString(R.string.qiniu_private_download));
		...
		this.exampleItemTitleList.add(Arrays.asList(this.getResources()
				.getStringArray(R.array.qiniu_public_download_values)));
		this.exampleItemTitleList.add(Arrays.asList(this.getResources()
				.getStringArray(R.array.qiniu_private_download_values)));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.qiniu_lab_main, menu);
		return true;
	}
