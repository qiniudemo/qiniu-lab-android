...
public class SimpleUploadUseEndUserActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.uploadTokenTextView = (TextView) this
				.findViewById(R.id.simple_upload_use_enduser_upload_token);
		this.uploadFileTextView = (TextView) this
				.findViewById(R.id.simple_upload_use_enduser_upload_file);
					...
					public void complete(String key, ResponseInfo respInfo,
						...
						if (respInfo.isOK()) {
							try {
								...
								String endUser = jsonData.getString("endUser");
								...
								uploadLogTextView.append("File Hash: "
										+ fileHash + "\r\n");
								uploadLogTextView.append("End User: " + endUser
										+ "\r\n");
