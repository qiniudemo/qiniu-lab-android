...
public class SimpleUploadOverwriteExistingFileActivity extends
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.uploadTokenTextView = (TextView) this
				.findViewById(R.id.simple_upload_overwrite_existing_file_token);
		this.uploadFileTextView = (TextView) this
				.findViewById(R.id.simple_upload_overwrite_existing_file_file);
	...
	public void getUploadToken(View view) {
		...
		try {
			postData = new String("key=" + key).getBytes("utf-8");
		...
		this.httpManager.postData(QiniuLabConfig.makeUrl(
				...
				postData, new Header[] { contentTypeHeader }, null,
