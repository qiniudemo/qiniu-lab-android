...
public class QiniuLabConfig {
	...
	public final static String SIMPLE_UPLOAD_USE_SAVE_KEY = "/demos/api/simple_upload_use_save_key_upload_token.php";
	public final static String SIMPLE_UPLOAD_USE_SAVE_KEY_FROM_XPARAM = "/demos/api/simple_upload_use_save_key_from_xparam_upload_token.php";
