...
public class CallbackUploadWithKeyInUrlFormatActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.uploadFileXParam1EditText = (EditText) this
                .findViewById(R.id.callback_upload_with_key_in_url_format_ex_param1);
        this.uploadFileXParam2EditText = (EditText) this
                .findViewById(R.id.callback_upload_with_key_in_url_format_ex_param2);
        this.uploadFileXParam3EditText = (EditText) this
                .findViewById(R.id.callback_upload_with_key_in_url_format_ex_param3);
        this.uploadProgressBar = (ProgressBar) this
                .findViewById(R.id.callback_upload_with_key_in_url_format_upload_progressbar);
        this.uploadProgressBar.setMax(100);
        this.uploadStatusLayout = (LinearLayout) this
                .findViewById(R.id.callback_upload_with_key_in_url_format_status_layout);
        this.uploadSpeedTextView = (TextView) this
                .findViewById(R.id.callback_upload_with_key_in_url_format_upload_speed_textview);
        this.uploadFileLengthTextView = (TextView) this
                .findViewById(R.id.callback_upload_with_key_in_url_format_upload_file_length_textview);
        this.uploadPercentageTextView = (TextView) this
                .findViewById(R.id.callback_upload_with_key_in_url_format_upload_percentage_textview);
        this.uploadStatusLayout.setVisibility(LinearLayout.INVISIBLE);
        this.uploadLogTextView = (TextView) this
                .findViewById(R.id.callback_upload_with_key_in_url_format_log_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                httpClient.get(QiniuLabConfig.makeUrl(
                        ...
                        QiniuLabConfig.CALLBACK_UPLOAD_WITH_KEY_IN_URL_FORMAT_PATH), null, new JsonHttpResponseHandler() {
                    @Override
