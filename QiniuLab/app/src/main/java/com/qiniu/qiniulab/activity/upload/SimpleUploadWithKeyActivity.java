...
public class SimpleUploadWithKeyActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.uploadProgressBar = (ProgressBar) this
                .findViewById(R.id.simple_upload_with_key_upload_progressbar);
        ...
        this.uploadSpeedTextView = (TextView) this
                .findViewById(R.id.simple_upload_with_key_upload_speed_textview);
        this.uploadFileLengthTextView = (TextView) this
                .findViewById(R.id.simple_upload_with_key_upload_file_length_textview);
        this.uploadPercentageTextView = (TextView) this
                .findViewById(R.id.simple_upload_with_key_upload_percentage_textview);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                httpClient.get(QiniuLabConfig.makeUrl(
                        ...
                        QiniuLabConfig.SIMPLE_UPLOAD_WITH_KEY_PATH), null, new JsonHttpResponseHandler() {
                    @Override
