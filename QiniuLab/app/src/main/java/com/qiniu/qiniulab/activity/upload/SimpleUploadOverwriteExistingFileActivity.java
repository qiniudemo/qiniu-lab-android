    ...
    public void uploadFile(View view) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Request req = new Request.Builder().url(String.format("%s?key=%s", QiniuLabConfig.makeUrl(
                        QiniuLabConfig.REMOTE_SERVICE_SERVER,
                        QiniuLabConfig.SIMPLE_UPLOAD_OVERWRITE_EXISTING_FILE_PATH), uploadFileKey)).method("GET", null).build();
                Response resp = null;
                try {
